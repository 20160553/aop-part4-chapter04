package fastcampus.aop_part4_chapter04
...
import fastcampus.aop_part4_chapter04.databinding.ActivityMainBinding
...
fun Activity.makeStautsBarTransparent() {
    window.apply {
